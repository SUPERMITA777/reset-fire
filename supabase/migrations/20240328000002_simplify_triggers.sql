-- Eliminar todos los triggers y funciones existentes relacionados con solapamientos
...
DROP TRIGGER IF EXISTS check_duplicado_exacto ON fechas_disponibles;
DROP FUNCTION IF EXISTS verificar_solapamiento_fechas();
DROP FUNCTION IF EXISTS verificar_solapamiento_horarios();
DROP FUNCTION IF EXISTS verificar_duplicado_exacto();

-- Crear una nueva función simplificada que solo verifica duplicados exactos
...
-- Crear el nuevo trigger simplificado
