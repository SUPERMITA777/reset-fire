...
import { Phone, MapPin, Clock, Instagram, Facebook, Twitter, Star, Sparkles, Heart, ArrowLeft } from "lucide-react"
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 w-full bg-white/95 backdrop-blur-sm z-50 border-b border-pearl-200">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Link href="/" className="text-sm text-charcoal/60 hover:text-gold transition-colors">
            Admin
          </Link>
        </div>
      </header>
            ...
            {config.testimonials.map((testimonial, index) => (
              <Card key={index} className="border-0 bg-white shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-charcoal/80 mb-6 italic leading-relaxed">&ldquo;{testimonial.text}&rdquo;</p>
